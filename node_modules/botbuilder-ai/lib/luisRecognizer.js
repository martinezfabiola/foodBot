...
class LuisRecognizer {
    ...
    recognize(context) {
        ...
        if (!cached) {
            ...
            return this.luisClient.prediction.resolve(this.application.applicationId, utterance, Object.assign({ verbose: this.options.includeAllIntents, customHeaders: { 'Ocp-Apim-Subscription-Key': this.application.endpointKey } }, this.options))
                .then((luisResult) => {
                // Map results
